...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text ='<ul class = "form-text text-muted small"><li>Your password can\'t be too similar to your other personal information.</li><li>Your password can\'t be a commonly used password</li><li>Your password can\'t be entirely numeric</li></ul>'
...
class AddRecordForm(forms.ModelForm):
    ...
    phone = forms.CharField(max_length=20, required=True, widget=forms.widgets.TextInput(attrs={'placeholder': "Phone", 'class': 'form-control'}), label='')
